...
class HomeController extends BaseController
{
    ...
    public function index()
    {
        ...
        $productLaptop = $this->productModel->selectAllProductByName(
            $columnProduct,
            $columnCategory,
            'id_category',
            'title_cate',
        ...
        $productPC = $this->productModel->selectAllProductByName(
            $columnProduct,
            $columnCategory,
            'id_category',
            'title_cate',
        ...
        if (!empty($_GET['search'])) {
            ...
            $search = $this->productModel->selectAllProductByName(
                $columnProduct,
                $columnCategory,
                'id_category',
                'title_cate',
