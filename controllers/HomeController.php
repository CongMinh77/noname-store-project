...
class HomeController extends BaseController
{
	...
	public function index()
	{
		...
		$productLaptop = $this->productModel->selectAllProductByName($columnProduct, $columnCategory, 
			'id_category','title_cate' ,'Laptop');

		$productPC = $this->productModel->selectAllProductByName($columnProduct, $columnCategory, 
			'id_category','title_cate' ,'Máy tính');
	...
	public function guarantee(){
		$this->includeView('layout.home_header');
		$this->loadView('front.home.guarantee');
