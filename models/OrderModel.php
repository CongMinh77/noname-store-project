...
class OrderModel extends BaseModel
{
    ...
    public function selectOrderTripleJoin(
        $table,
        $table1,
        $table2,
        $select = [''],
    ...
    public function selectOrderTripleJoinById(
        $table,
        $table1,
        $table2,
        $select = [''],
    ...
    {
        return $this->selectAllJoinById(
            self::TABLE_ORDER_DETAIL,
            self::TABLE_PRODUCT,
            $select,
            $select1,
            $id,
    ...
    {
        return $this->innerjoinPaging(
            self::TABLE_ORDER_ACCOUNT,
            self::TABLE_ACCOUNT,
            $select,
            $select1,
            $id,
