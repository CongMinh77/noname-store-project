	...
	<main>
				...
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner rounded">
						<div class="carousel-item active">
							<img class="d-block img_show " src="./assets/image/girl_pr1.jpg" alt="First slide">
						</div>
						<div class="carousel-item">
							<img class="d-block img_show" src="./assets/image/girl_pr.jpg" alt="Second slide">
						</div>
						<div class="carousel-item">
							<img class="d-block img_show" src="./assets/image/ALIENWARE.jpg" alt="Third slide">
						</div>
						<div class="carousel-item">
							<img class="d-block img_show" src="./assets/image/hunter_msi.jpg" alt="fourth slide">
						</div>
						<div class="carousel-item">
							<img class="d-block img_show" src="./assets/image/RAZER_BLADE_GAMING_LAPTOP_game_computer1.jpg" alt="fifth slide">
						</div>
					</div>
			...
			<div class="pt-3">
				<div class="container-fluid pb-3">
					<div class="d-flex position-relative bg-default rounded pl-2 pr-2 p-2">
						<h2 class="text-white pl-3">Laptop</h2>
						<a href="detail&action=portfolio&product=Laptop" class="explore d-flex align-items-center text-white pr-4">Xem thêm<i class="fas fa-angle-right ml-1"></i></a>
					</div>
				</div>
		...
		<section>
			<div class="pt-3">
				<div class="container-fluid pb-3">
					<div class="d-flex position-relative bg-default rounded pl-2 pr-2 p-2">
						<h2 class="text-white pl-3">Máy tính</h2>
						<a href="detail&action=portfolio&product=Máy tính" class="explore d-flex align-items-center text-white pr-4">Xem thêm<i class="fas fa-angle-right ml-1"></i></a>
					</div>
				</div>
				<div class="container-fluid">	
					<div class="row row-cols-4">
						<?php
						foreach ($productPC as $product) {
							$price = number_format($product['price'],0,'','.');
							echo '<div class="col-3 mt-2 mb-3" style="height: 30rem">
								<div class="container-fluid border-0 bg-light h-100 position-relative pt-3 card">
									<div class="img">
		...
		<section class="container-fluid p-0 bg-image mt-5 mb-5 position-relative" 
					style="height: 30rem;">
			<div class="container m-auto h-100 d-flex align-items-center">
				<div class="rounded bg-light text-dark p-4 bg-gradient" style="width: 20rem;">
					<h3 class="text-white">Ưu đãi cực khủng <br>giảm đến 10%</h3>
					<a href=""></a>
