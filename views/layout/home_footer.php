			...
			<div class="d-flex">
				<ul class="nav flex-column">
					<li class="nav-item d-flex text-white">
						...
						<h6 class="mb-3">Thang Long University</h6>
					</li>
					<li class="nav-item d-flex text-white">
						<i class="fas fa-phone-alt mt-1 mr-3"></i>
						<a class="text-white mb-3" href="tel:+84949389572">
							<h6 class="m-0">+84 949 389 572</h6>
						</a>
					</li>
					<li class="nav-item d-flex text-white">
						<i class="fas fa-envelope mt-1 mr-3"></i>
						<a class="text-white mb-3" href="mailto:congminh.se7en@gmail.com">
							<h6>congminh.se7en@noname.com</h6>
						</a>
					</li>
				</ul>
			</div>
			...
			<div class="container">
				...
				<ul class="nav flex-column">
					<li class="nav-item d-flex">
						<a href="home&action=guarantee" class="text-white mb-3"><h6>Chính sách bảo hành</h6></a>
					</li>
					<li class="nav-item d-flex">
	...
	<section class="container">
		<div class="container-fluid d-flex p-3 justify-content-center">
			<div class="text-white d-flex align-items-center">
				<h6 class="mt-1">© Copyright NCM. Developed by NCM</h6>
				<ul class="nav d-flex ml-5">
					<li class="nav-item d-flex mr-3">
						<a href="https://www.facebook.com/NCM.SE7EN" target="_blank" class="text-white"><i class="fab fa-facebook-f fa-lg"></i></a>
					</li>
					<li class="nav-item d-flex mr-3">
