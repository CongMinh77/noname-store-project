			...
			<div class="dropdown">
				...
				<div class="dropdown-menu m-0" aria-labelledby="navbarDropdown">
					<div class="container-fluid">
						<a class="dropdown-item" href="detail&action=portfolio&product=Laptop"><i class="fas fa-laptop mr-1"></i>Laptop</a>
						<a class="dropdown-item" href="detail&action=portfolio&product=Máy tính"><i class="fas fa-desktop mr-1"></i>Máy tính</a>
						<a class="dropdown-item" href="detail&action=portfolio&product=Linh kiện"><i class="far fa-hdd mr-1"></i>Linh kiện</a>
					</div>
			...
			<div class="collapse navbar-collapse pl-5" id="navbarSupportedContent">
				<ul class="navbar-nav">
					...
					<li class="nav-item pr-4">
						<a class="nav-link text-white p-3" href="detail&action=portfolio&product=Sản phẩm mới"><i class="fas fa-plus-circle mr-1"></i>Sản phẩm mới</a>
					</li>
					<li class="nav-item pr-4">
						<a class="nav-link text-white p-3" href="detail&action=portfolio&product=Bán chạy"><i class="fas fa-dollar-sign mr-1"></i></i>Bán chạy</a>
					</li>
					<li class="nav-item pr-4">
					...
					<li class="nav-item dropdown pr-4">
						...
						<div class="dropdown-menu m-0 pt-1" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="home&action=guarantee">Chính sách bảo hành</a>
